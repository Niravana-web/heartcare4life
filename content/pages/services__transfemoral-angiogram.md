---
{
 "route": "/services/transfemoral-angiogram",
 "title": "Transfemoral Angiogram (Groin Access)",
 "h1": "Transfemoral Angiogram",
 "description": "A transfemoral angiogram images your arteries through the femoral artery in the groin. Learn when this route is used, how to prepare, and what recovery needs.",
 "sourceUrl": "https://www.heartcare4life.com/transfemoral-angiogram-interventional-cardiologist-bonita-redding-san-diego-ca/",
 "legacyUrls": [
  "https://www.heartcare4life.com/transfemoral-angiogram-interventional-cardiologist-bonita-redding-ca/"
 ],
 "youtube": []
}
---
...
- Ongoing [chest pain](/conditions/chest-pain) or breathlessness that suggests reduced blood flow to the heart.
- Known or suspected [coronary artery disease](/conditions/coronary-artery-disease) that may need treatment.
...
- Evaluation of an [aortic aneurysm](/conditions/aortic-aneurysm) or other vessel abnormality.
- Planning for a structural heart or vascular procedure that needs larger equipment.

The [National Heart, Lung, and Blood Institute](https://www.nhlbi.nih.gov/health/cardiac-catheterization) describes how catheter-based artery studies are performed and used.

### Groin versus wrist access

The alternative is a [transradial angiogram](/services/transradial-angiogram) through the wrist. Image quality is the same either way, and the tradeoffs are practical.
...
A significant blockage may be found. Treatment such as [angioplasty](/services/angioplasty) or coronary stenting can often be done immediately, avoiding a second procedure.
...
The [American Heart Association](https://www.heart.org/en/health-topics/peripheral-artery-disease) provides background on artery disease outside the heart, which this study often evaluates.

## Related services and conditions

- [Transradial angiogram](/services/transradial-angiogram), the wrist access alternative.
- [PTCA](/services/ptca) for balloon treatment of a narrowed artery.
- [Ankle brachial index](/services/ankle-brachial-index-abi) for non-invasive leg circulation screening.
- [Vascular ultrasound](/services/vascular-ultrasound) to assess arteries and veins without dye.
