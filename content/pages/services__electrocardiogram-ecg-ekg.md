...
A normal ECG is reassuring but limited. It captures only ten seconds, so an intermittent rhythm problem can easily be missed. A normal tracing also does not exclude coronary artery disease. That is why symptoms that come and go often lead to [Holter monitoring](/services/holter-monitoring) or a longer [7 to 10 day ambulatory rhythm monitor](/services/7-10-day-ambulatory-rhythm-monitor).
