---
{
 "route": "/services/ihd-evaluation",
 "title": "Ischemic Heart Disease (IHD) Evaluation",
 "h1": "IHD Evaluation",
 "description": "IHD evaluation is the step-by-step workup for reduced blood flow to the heart, using blood tests, imaging, and stress testing to find and grade blockages.",
 "sourceUrl": "https://www.heartcare4life.com/ihd-evaluation-interventional-cardiologist-bonita-redding-san-diego-ca/",
 "legacyUrls": [
  "https://www.heartcare4life.com/ihd-evaluation-interventional-cardiologist-bonita-redding-ca/"
 ],
 "youtube": []
}
---
...
Ischemic heart disease is the most common form of heart disease, and it is often treatable long before a heart attack occurs. The [National Heart, Lung, and Blood Institute describes coronary heart disease and its causes](https://www.nhlbi.nih.gov/health/coronary-heart-disease). The [American Heart Association explains the warning signs of a heart attack](https://www.heart.org/en/health-topics/heart-attack).
...
An [electrocardiogram](/services/electrocardiogram-ecg-ekg) records the heart's electrical activity and can show evidence of a prior heart attack or ongoing strain. An [echocardiogram](/services/echocardiogram) shows chamber size, valve function, and pumping strength. It can also reveal areas of muscle that move poorly because of reduced blood supply.

Functional testing comes next when needed. A treadmill or medication-based stress test shows whether blood flow falls short under demand. Imaging is sometimes added, such as [advanced stress testing](/services/advanced-stress-testing).

Anatomic imaging such as [coronary CT angiography](/services/coronary-ct-angiography) pictures the arteries directly. If the findings suggest a severe blockage, a coronary angiogram in a hospital catheterization laboratory maps the arteries precisely. It also allows treatment during the same procedure.
