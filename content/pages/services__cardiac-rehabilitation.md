---
{
 "route": "/services/cardiac-rehabilitation",
 "title": "Cardiac Rehabilitation",
 "h1": "Cardiac Rehabilitation",
 "description": "Cardiac rehabilitation is a supervised program of exercise, education, and counseling after a heart event. What it involves, who benefits, and what to expect.",
 "sourceUrl": "https://www.heartcare4life.com/cardiac-rehabilitation-interventional-cardiologist-bonita-redding-san-diego-ca/",
 "legacyUrls": [
  "https://www.heartcare4life.com/cardiac-rehabilitation-interventional-cardiologist-bonita-redding-ca/"
 ],
 "youtube": []
}
---
...
The weeks after a cardiac event are when habits are most changeable. They are also when the risk of a second event is highest. Rehabilitation uses that window deliberately. The [American Heart Association explains what cardiac rehab involves and why it is recommended](https://www.heart.org/en/health-topics/cardiac-rehab), and [MedlinePlus reviews the evidence behind cardiac rehabilitation](https://medlineplus.gov/cardiacrehabilitation.html).
...
- Expect a baseline evaluation. It usually includes a history, an examination, an [electrocardiogram](/services/electrocardiogram-ecg-ekg), and sometimes an exercise test to set safe target intensities.
...
Stop and tell staff immediately if you have chest pressure, unusual shortness of breath, lightheadedness, palpitations, or a cold sweat. Programs are also cautious about starting or continuing sessions when blood pressure is very high or very low. The same is true when an infection is active, or when [arrhythmias](/conditions/arrhythmias) are unstable.
