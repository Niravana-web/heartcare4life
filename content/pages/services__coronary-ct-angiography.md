---
{
 "route": "/services/coronary-ct-angiography",
 "title": "Coronary CT Angiography (CCTA)",
 "h1": "Coronary CT Angiography",
 "description": "Coronary CT angiography is a noninvasive scan that pictures the heart arteries using contrast dye through an arm vein. Preparation, procedure, and results.",
 "sourceUrl": "https://www.heartcare4life.com/coronary-ct-angiography-interventional-cardiologist-bonita-redding-san-diego-ca/",
 "legacyUrls": [
  "https://www.heartcare4life.com/coronary-ct-angiography-interventional-cardiologist-bonita-redding-ca/"
 ],
 "youtube": []
}
---
...
A normal scan means the arteries are open, and the likelihood of a heart attack in the near term is very low. Mild or moderate plaque usually leads to prevention. That means cholesterol lowering, blood pressure and blood sugar control, and exercise. It often means [advanced lipid testing](/services/advanced-lipid-testing) to refine risk. A severe narrowing may lead to functional testing such as [advanced stress testing](/services/advanced-stress-testing). It may also lead to a coronary angiogram and possible [coronary stenting](/services/coronary-stenting).
