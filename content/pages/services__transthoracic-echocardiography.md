---
{
 "route": "/services/transthoracic-echocardiography",
 "title": "Transthoracic Echocardiography (TTE)",
 "h1": "Transthoracic Echocardiography",
 "description": "A transthoracic echocardiogram uses ultrasound through the chest wall to show your heart working. Learn what it shows, how to prepare, and how results arrive.",
 "sourceUrl": "https://www.heartcare4life.com/transthoracic-echocardiography-interventional-cardiologist-bonita-redding-san-diego-ca/",
 "legacyUrls": [
  "https://www.heartcare4life.com/transthoracic-echocardiography-interventional-cardiologist-bonita-redding-ca/"
 ],
 "youtube": []
}
---
...
An [echocardiogram](/services/echocardiogram) answers questions that a physical exam and an [electrocardiogram](/services/electrocardiogram-ecg-ekg) cannot. It shows structure and pumping function rather than electrical activity.

Common reasons include:

- Shortness of breath, fatigue, swelling in the legs, or reduced exercise tolerance.
- A [heart murmur](/conditions/heart-murmur) heard during an exam.
- [Chest pain](/conditions/chest-pain) that needs a broader heart evaluation.
...
The [National Heart, Lung, and Blood Institute](https://www.nhlbi.nih.gov/health/heart-tests) describes the range of problems echocardiography can identify.
...
Dr. Nanavati will explain the findings in practical terms. He will say how strongly the heart is pumping, and whether any valve needs watching. Many findings simply mean a repeat scan in a year. Others lead to further testing. [Advanced stress testing](/services/advanced-stress-testing) follows if reduced blood flow is suspected, and a [transesophageal echocardiogram](/services/transesophageal-echocardiography) gives a closer view of a valve or the upper chambers. Treatment may involve medication changes, blood pressure control, or referral for valve care.
...
One honest limitation is worth knowing. Image quality depends on your body's acoustic windows. Lung disease, obesity, chest deformity, or scarring can make pictures harder to obtain. A contrast agent may then be used to brighten the chamber borders, or a different test may be recommended. [MedlinePlus](https://medlineplus.gov/heartdiseases.html) offers a general overview of heart conditions this study helps evaluate.

## Related services and conditions

- [Nuclear stress test](/services/nuclear-stress-test) when blood flow needs assessment.
- [Holter monitoring](/services/holter-monitoring) for rhythm questions.
- [Heart anatomy](/conditions/heart-anatomy) explained in plain language.
- [Vascular ultrasound](/services/vascular-ultrasound) for arteries and veins outside the heart.
- [Cardiology services](/services/cardiology-services) at our Bonita, San Diego, and Redding offices.
