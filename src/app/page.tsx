...
const SPOTLIGHT = [
  { title: "Advanced Lipid Testing", href: "/services/advanced-lipid-testing", img: "/images/advanced-lipid-testing-hme.png", body: "Evaluation of cardiovascular risk by measuring particle size, particle number, inflammation markers, and genetic contributors to cholesterol abnormalities. This comprehensive assessment helps identify hidden risks, personalize treatment plans, and guide targeted therapies to better prevent heart attack, stroke, and long-term cardiovascular disease." },
  { title: "Minimally Invasive Coronary Stenting", href: "/services/coronary-stenting", img: "/images/minimally-invasive-coronary-stenting-hme.png", body: "Procedure used to open narrowed or blocked coronary arteries. A small mesh tube, called a stent, is placed to keep the artery open, restoring blood flow to the heart. It relieves chest pain, reduces heart attack risk, and improves overall cardiac function." },
  { title: "Structural Heart Procedures: Left Atrial Appendage Closure", href: "/services/left-atrial-appendage-closure", img: "/images/structural-heart-procedures-left-atrial-appendage-closure-hme.png", body: "Left atrial appendage closure (LAAC) is a minimally invasive procedure that helps prevent strokes in patients with atrial fibrillation. A small device seals off a small heart pouch called the left atrial appendage, reducing the risk of blood clots. It's an alternative for patients who cannot take long-term blood thinners." },
];
