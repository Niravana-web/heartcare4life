...
export default function HeroVideo() {
  ...
  return (
    <section className="relative h-[68svh] max-h-[720px] min-h-[440px] overflow-hidden bg-navy-2" aria-label="Welcome">
      ...
      <img src="/images/hero-poster.webp" srcSet="/images/hero-poster-900.webp 900w, /images/hero-poster.webp 1600w" sizes="100vw" alt="" width={1600} height={686} fetchPriority="high" decoding="async" className="absolute inset-0 h-full w-full object-cover" aria-hidden="true" />
